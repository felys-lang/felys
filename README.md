...
The project is temporarily archived, but here are some future tasks.

- Use block argument instead of Phi nodes
- Design a new logo to eliminate the need of [disclaimers](#copyright)
- Refactor the parser generator and virtual machine
