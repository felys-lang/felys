...
impl super::PhiLia093 {
    ...
    pub fn union(&mut self) -> Option<Regex> {
        ...
        loop {
            ...
            self.__memo.union.insert(start, (end, cache));
    ...
    pub fn concat(&mut self) -> Option<Regex> {
        ...
        loop {
            let cache = result.clone();
            self.__memo.concat.insert(start, (end, cache));
            let temp = self.__peg(RULES);
            if end < self.__stream.cursor {
                result = temp;
                end = self.__stream.cursor;
    ...
    pub fn repeat(&mut self) -> Option<Regex> {
        ...
        loop {
            let cache = result.clone();
            self.__memo.repeat.insert(start, (end, cache));
            let temp = self.__peg(RULES);
            if end < self.__stream.cursor {
                result = temp;
                end = self.__stream.cursor;
    ...
    pub fn PS(&mut self) -> Option<usize> {
        ...
        fn transition(s: usize, c: char) -> Option<usize> {
            let s = match (s, c as usize) {
                ...
                (1usize, 0usize..=39usize) => 1usize,
                (1usize, 42usize..=18446744073709551615usize) => 1usize,
                _ => return None,
            };
            Some(s)
        }
    ...
    pub fn BS(&mut self) -> Option<usize> {
        ...
        fn transition(s: usize, c: char) -> Option<usize> {
            let s = match (s, c as usize) {
                ...
                (0usize, 126usize..=18446744073709551615usize) => 1usize,
                (1usize, 0usize..=122usize) => 1usize,
                (1usize, 124usize..=124usize) => 1usize,
                (1usize, 126usize..=18446744073709551615usize) => 1usize,
                _ => return None,
            };
            Some(s)
        }
