...
fn elysia(_: Vec<Object>, _: &Elysia, _: &mut String) -> Object {
    Object::Str("粉色妖精小姐♪".into())
}

fn cyrene(_: Vec<Object>, _: &Elysia, _: &mut String) -> Object {
    Object::Str("往昔的涟漪♪".into())
}

fn felysneko(_: Vec<Object>, _: &Elysia, _: &mut String) -> Object {
