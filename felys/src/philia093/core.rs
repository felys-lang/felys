...
impl super::PhiLia093 {
    pub fn root(&mut self) -> Option<Root> {
        ...
        const RULES: super::R<Root, 1usize> = [|x| {
    ...
    pub fn item(&mut self) -> Option<Item> {
        ...
        const RULES: super::R<Item, 4usize> = [
            ...
            |x| {
                ...
                let more = {
                    let mut body = Vec::new();
                    while let Some(data) = x.implementation() {
                        body.push(data)
                    }
                    body
                };
    ...
    pub fn implementation(&mut self) -> Option<Impl> {
        ...
        const RULES: super::R<Impl, 2usize> = [
            |x| {
                let _ = x.FN()?;
                let ident = match x.IDENT() {
                    Some(value) => value,
    ...
    pub fn pat(&mut self) -> Option<Pat> {
        ...
        const RULES: super::R<Pat, 3usize> = [
            |x| {
                let _ = x.UNDERSCORE()?;
                Some(Pat::Any)
            },
    ...
    pub fn block(&mut self) -> Option<Block> {
        ...
        const RULES: super::R<Block, 1usize> = [|x| {
            let _ = x.LBRA()?;
            let stmts = {
                let mut body = Vec::new();
    ...
    pub fn stmt(&mut self) -> Option<Stmt> {
        ...
        const RULES: super::R<Stmt, 4usize> = [
            |x| {
    ...
    pub fn assignment(&mut self) -> Option<Stmt> {
        ...
        const RULES: super::R<Stmt, 6usize> = [
            |x| {
                let pat = x.pat()?;
                let _ = x.EQ()?;
    ...
    pub fn expr(&mut self) -> Option<Expr> {
        ...
        const RULES: super::R<Expr, 6usize> = [
            |x| {
    ...
    pub fn equality(&mut self) -> Option<Expr> {
        ...
        const RULES: super::R<Expr, 3usize> = [
            |x| {
                let lhs = x.equality()?;
                let _ = x.EQ2()?;
    ...
    pub fn comparison(&mut self) -> Option<Expr> {
        ...
        const RULES: super::R<Expr, 5usize> = [
            |x| {
    ...
    pub fn factor(&mut self) -> Option<Expr> {
        ...
        const RULES: super::R<Expr, 4usize> = [
            |x| {
                let lhs = x.factor()?;
                let _ = x.ASTERISK()?;
                let rhs = match x.at() {
    ...
    pub fn args(&mut self) -> Option<BufVec<Expr, 1>> {
        ...
        const RULES: super::R<BufVec<Expr, 1>, 1usize> = [|x| {
            let first = x.expr()?;
            let more = {
                let mut body = Vec::new();
                while let Some(data) = x.__peg([|x| {
    ...
    pub fn primary(&mut self) -> Option<Expr> {
        ...
        const RULES: super::R<Expr, 8usize> = [
            |x| {
                let lit = x.lit()?;
                Some(Expr::Lit(lit))
            },
    ...
    pub fn lit(&mut self) -> Option<Lit> {
        ...
        const RULES: super::R<Lit, 4usize> = [
            |x| {
                let float = x.FLOAT()?;
    ...
    pub fn STR(&mut self) -> Option<Vec<Chunk>> {
        ...
        const RULES: super::R<Vec<Chunk>, 1usize> = [|x| {
            let _ = {
                let mut body = Vec::new();
                while let Some(data) = x.T() {
                    body.push(data)
    ...
    pub fn BOOL(&mut self) -> Option<Bool> {
        ...
        const RULES: super::R<Bool, 2usize> = [
            |x| {
                let _ = {
                    let mut body = Vec::new();
                    while let Some(data) = x.T() {
    ...
    pub fn CHUNK(&mut self) -> Option<Chunk> {
        ...
        const RULES: super::R<Chunk, 3usize> = [
            |x| {
                let slice = x.SLICE()?;
