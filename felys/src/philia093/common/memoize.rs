...
#[derive(Default)]
pub struct Memo {
    pub pat: HashMap<usize, (usize, Option<Pat>)>,
    pub expr: HashMap<usize, (usize, Option<Expr>)>,
    pub disjunction: HashMap<usize, (usize, Option<Expr>)>,
    pub conjunction: HashMap<usize, (usize, Option<Expr>)>,
    pub equality: HashMap<usize, (usize, Option<Expr>)>,
